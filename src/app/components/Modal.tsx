...
const Modal = ({open=false,onClosefunc, children}) => {
    ...
    return (
        ...
        <div onClick={onClosefunc} hidden={!isOpen} className='fixed transition inset-0 z-40 bg-black/50 data-[state=open]:animate-fadeOut data-[state=closed]:animate-fadeIn'>
            <div data-state={isOpen ? 'open':'closed'} role='dialog' className='flex flex-col fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] z-50  w-[90%] rounded-lg bg-background  max-w-4xl  gap-4 p-6 shadow-lg duration-200 sm:rounded-lg sm:max-w-[425px]'>
                {/* {children} */}
