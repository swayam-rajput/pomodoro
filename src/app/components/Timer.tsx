        ...
        <div className='w-[80%] mb-16 mx-auto md:w-full h-full flex justify-center items-center'>
            <div className='md:w-[60%] w-full flex flex-col gap-y-10'>
                ...
                <div id='playpause' className='flex justify-center transition-all z-30 flex-row gap-4'>
                    ...
                    {(showReset)
                        &&
                        <button onClick={resetTimer} className='flex transition justify-center py-2 active:bg-text-primary px-1 rounded-md text-text-accent' >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon" className="w-8 h-8 text-text-primary active:text-text-accent">
